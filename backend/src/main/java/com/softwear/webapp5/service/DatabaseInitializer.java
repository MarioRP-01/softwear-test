...
public class DatabaseInitializer {
	...
	public void init() throws FileNotFoundException {
		...
		imgsItem1.add("src/main/resources/static/assets/productos/item1.webp");
		imgsItem2.add("src/main/resources/static/assets/productos/item2.webp");
		imgsItem3.add("src/main/resources/static/assets/productos/item3.webp");
		imgsItem4.add("src/main/resources/static/assets/productos/item4.webp");
		imgsItem5.add("src/main/resources/static/assets/productos/item5.webp");
		imgsItem6.add("src/main/resources/static/assets/productos/item6.webp");
		imgsItem7.add("src/main/resources/static/assets/productos/item7.webp");
		imgsItem8.add("src/main/resources/static/assets/productos/item8.webp");
		imgsItem9.add("src/main/resources/static/assets/productos/item9-1.webp");
		imgsItem9.add("src/main/resources/static/assets/productos/item9-2.webp");
		imgsItem9.add("src/main/resources/static/assets/productos/item9-3.webp");
		imgsItem10.add("src/main/resources/static/assets/productos/item10.webp");
		imgsItem11.add("src/main/resources/static/assets/productos/item11-1.webp");
		imgsItem11.add("src/main/resources/static/assets/productos/item11-2.webp");
		imgsItem12.add("src/main/resources/static/assets/productos/item12.webp");
		imgsItem13.add("src/main/resources/static/assets/productos/item13-1.webp");
		imgsItem13.add("src/main/resources/static/assets/productos/item13-2.webp");
		imgsItem13.add("src/main/resources/static/assets/productos/item13-3.webp");
		imgsItem14.add("src/main/resources/static/assets/productos/item14.webp");
		imgsItem15.add("src/main/resources/static/assets/productos/item15.webp");
		...
		Product puffer_jacket_S = new Product("Puffer jacket", description_puffer_jacket, 45, (long) 99, ProductSize.S, imgsItem1, blobItem1);
		Product puffer_jacket_M = new Product("Puffer jacket", description_puffer_jacket, 45, (long) 23, ProductSize.M, imgsItem1, blobItem1);
		Product puffer_jacket_L = new Product("Puffer jacket", description_puffer_jacket, 45, (long) 109, ProductSize.L, imgsItem1, blobItem1);
		Product puffer_jacket_XL = new Product("Puffer jacket", description_puffer_jacket, 45, (long) 0, ProductSize.XL, imgsItem1, blobItem1);
		...
		Product cowboy_jacket_S = new Product("Cowboy jacket", description_cowboy_jacket, 60, (long) 8, ProductSize.S, imgsItem2, blobItem2);
		Product cowboy_jacket_M = new Product("Cowboy jacket", description_cowboy_jacket, 60, (long) 44, ProductSize.M, imgsItem2, blobItem2);
		Product cowboy_jacket_L = new Product("Cowboy jacket", description_cowboy_jacket, 60, (long) 0, ProductSize.L, imgsItem2, blobItem2);
		Product cowboy_jacket_XL = new Product("Cowboy jacket", description_cowboy_jacket, 60, (long) 2, ProductSize.XL, imgsItem2, blobItem2);
		...
		Product facha_jacket_S = new Product("Facha jacket", description_facha_jacket, 40, (long) 45, ProductSize.S, imgsItem3, blobItem3);
		Product facha_jacket_M = new Product("Facha jacket", description_facha_jacket, 40, (long) 0, ProductSize.M, imgsItem3, blobItem3);
		Product facha_jacket_L = new Product("Facha jacket", description_facha_jacket, 40, (long) 2, ProductSize.L, imgsItem3, blobItem3);
		Product facha_jacket_XL = new Product("Facha jacket", description_facha_jacket, 40, (long) 7, ProductSize.XL, imgsItem3, blobItem3);
		...
		Product happy_jaccket_S = new Product("Happy jacket", description_happy_jacket, 55, (long) 0, ProductSize.S, imgsItem4, blobItem4);
		Product happy_jaccket_M = new Product("Happy jacket", description_happy_jacket, 55, (long) 0, ProductSize.M, imgsItem4, blobItem4);
		Product happy_jaccket_L = new Product("Happy jacket", description_happy_jacket, 55, (long) 1, ProductSize.L, imgsItem4, blobItem4);
		Product happy_jaccket_XL = new Product("Happy jacket", description_happy_jacket, 55, (long) 4, ProductSize.XL, imgsItem4, blobItem4);
		...
		Product longsleeves_S = new Product("Long sleeves shirt", description_happy_jacket, 35, (long) 32, ProductSize.S, imgsItem5, blobItem5);
		Product longsleeves_M = new Product("Long sleeves shirt", description_happy_jacket, 35, (long) 61, ProductSize.M, imgsItem5, blobItem5);
		Product longsleeves_L = new Product("Long sleeves shirt", description_happy_jacket, 35, (long) 3, ProductSize.L, imgsItem5, blobItem5);
		Product longsleeves_XL = new Product("Long sleeves shirt", description_happy_jacket, 35, (long) 40, ProductSize.XL, imgsItem5, blobItem5);
		...
		Product paris_shirt_S = new Product("Paris shirt", description_paris_shirt, 31, (long) 21, ProductSize.S, imgsItem6, blobItem6);
		Product paris_shirt_M = new Product("Paris shirt", description_paris_shirt, 31, (long) 29, ProductSize.M, imgsItem6, blobItem6);
		Product paris_shirt_L = new Product("Paris shirt", description_paris_shirt, 31, (long) 35, ProductSize.L, imgsItem6, blobItem6);
		Product paris_shirt_XL = new Product("Paris shirt", description_paris_shirt, 31, (long) 54, ProductSize.XL, imgsItem6, blobItem6);
		...
		Product black_body_S = new Product("Black body", description_black_body, 40, (long) 31, ProductSize.S, imgsItem7, blobItem7);
		Product black_body_M = new Product("Black body", description_black_body, 40, (long) 46, ProductSize.M, imgsItem7, blobItem7);
		Product black_body_L = new Product("Black body", description_black_body, 40, (long) 30, ProductSize.L, imgsItem7, blobItem7);
		Product black_body_XL = new Product("Black body", description_black_body, 40, (long) 44, ProductSize.XL, imgsItem7, blobItem7);
		...
		Product black_shirt_S = new Product("Black shirt", description_black_shirt, 40, (long) 31, ProductSize.S, imgsItem8, blobItem8);
		Product black_shirt_M = new Product("Black shirt", description_black_shirt, 40, (long) 46, ProductSize.M, imgsItem8, blobItem8);
		Product black_shirt_L = new Product("Black shirt", description_black_shirt, 40, (long) 30, ProductSize.L, imgsItem8, blobItem8);
		Product black_shirt_XL = new Product("Black shirt", description_black_shirt, 40, (long) 44, ProductSize.XL, imgsItem8, blobItem8);
		...
		Product arizona_jeans_S = new Product("Arizona jeans", description_arizona_jeans, 95, (long) 31, ProductSize.S, imgsItem9, blobItem9);
		Product arizona_jeans_M = new Product("Arizona jeans", description_arizona_jeans, 95, (long) 10, ProductSize.M, imgsItem9, blobItem9);
		Product arizona_jeans_L = new Product("Arizona jeans", description_arizona_jeans, 95, (long) 35, ProductSize.L, imgsItem9, blobItem9);
		Product arizona_jeans_XL = new Product("Arizona jeans", description_arizona_jeans, 95, (long) 48, ProductSize.XL, imgsItem9, blobItem9);
		...
		Product topos_dress_S = new Product("Topos dress", description_topos_dress, 72, (long) 24, ProductSize.S, imgsItem10, blobItem10);
		Product topos_dress_M = new Product("Topos dress", description_topos_dress, 72, (long) 31, ProductSize.M, imgsItem10, blobItem10);
		Product topos_dress_L = new Product("Topos dress", description_topos_dress, 72, (long) 30, ProductSize.L, imgsItem10, blobItem10);
		Product topos_dress_XL = new Product("Topos dress", description_topos_dress, 72, (long) 68, ProductSize.XL, imgsItem10, blobItem10);
		...
		Product winter_jacket_S = new Product("Winter jacket", description_winter_jacket, 99, (long) 24, ProductSize.S, imgsItem11, blobItem11);
		Product winter_jacket_M = new Product("Winter jacket", description_winter_jacket, 99, (long) 34, ProductSize.M, imgsItem11, blobItem11);
		Product winter_jacket_L = new Product("Winter jacket", description_winter_jacket, 99, (long) 3, ProductSize.L, imgsItem11, blobItem11);
		Product winter_jacket_XL = new Product("Winter jacket", description_winter_jacket, 99, (long) 25, ProductSize.XL, imgsItem11, blobItem11);
		...
		Product creamy_pants_S = new Product("Winter jacket", description_creamy_pants, 86, (long) 40, ProductSize.S, imgsItem12, blobItem12);
		Product creamy_pants_M = new Product("Winter jacket", description_creamy_pants, 86, (long) 16, ProductSize.M, imgsItem12, blobItem12);
		Product creamy_pants_L = new Product("Winter jacket", description_creamy_pants, 86, (long) 11, ProductSize.L, imgsItem12, blobItem12);
		Product creamy_pants_XL = new Product("Winter jacket", description_creamy_pants, 86, (long) 5, ProductSize.XL, imgsItem12, blobItem12);
		...
		Product oversize_hoodie_S = new Product("Oversize hoodie", description_oversize_hoodie, 74, (long) 4, ProductSize.S, imgsItem13, blobItem13);
		Product oversize_hoodie_M = new Product("Oversize hoodie", description_oversize_hoodie, 74, (long) 16, ProductSize.M, imgsItem13, blobItem13);
		Product oversize_hoodie_L = new Product("Oversize hoodie", description_oversize_hoodie, 74, (long) 0, ProductSize.L, imgsItem13, blobItem13);
		Product oversize_hoodie_XL = new Product("Oversize hoodie", description_oversize_hoodie, 74, (long) 9, ProductSize.XL, imgsItem13, blobItem13);
		...
		Product yellow_set_S = new Product("Yellow set", description_yellow_set, 110, (long) 0, ProductSize.S, imgsItem14, blobItem14);
		Product yellow_set_M = new Product("Yellow set", description_yellow_set, 110, (long) 15, ProductSize.M, imgsItem14, blobItem14);
		Product yellow_set_L = new Product("Yellow set", description_yellow_set, 110, (long) 3, ProductSize.L, imgsItem14, blobItem14);
		Product yellow_set_XL = new Product("Yellow set", description_yellow_set, 110, (long) 36, ProductSize.XL, imgsItem14, blobItem14);
		...
		Product pocket_pants_S = new Product("Pocket pistachio pants", description_pocket_pants, 84, (long) 15, ProductSize.S, imgsItem15, blobItem15);
		Product pocket_pants_M = new Product("Pocket pistachio pants", description_pocket_pants, 84, (long) 1, ProductSize.M, imgsItem15, blobItem15);
		Product pocket_pants_L = new Product("Pocket pistachio pants", description_pocket_pants, 84, (long) 34, ProductSize.L, imgsItem15, blobItem15);
		Product pocket_pants_XL = new Product("Pocket pistachio pants", description_pocket_pants, 84, (long) 6, ProductSize.XL, imgsItem15, blobItem15);
		...
		Product goodvibes_set_S = new Product("Good vibes set", description_goodvibes_set, 125, (long) 13, ProductSize.S, imgsItem16, blobItem16);
		Product goodvibes_set_M = new Product("Good vibes set", description_goodvibes_set, 125, (long) 4, ProductSize.M, imgsItem16, blobItem16);
		Product goodvibes_set_L = new Product("Good vibes set", description_goodvibes_set, 125, (long) 25, ProductSize.L, imgsItem16, blobItem16);
		Product goodvibes_set_XL = new Product("Good vibes set", description_goodvibes_set, 125, (long) 6, ProductSize.XL, imgsItem16, blobItem16);
	...
	public void blobInitializer(List<String> imgsItem, ArrayList<Blob> blobItem1, int itemNum) throws FileNotFoundException{
		for(int i = 0; i < imgsItem.size(); i++) {
			String image = imgsItem.get(i);
			File imageFile = new File(image);
			blobItem1.add(BlobProxy.generateProxy(
					new FileInputStream(imageFile), imageFile.length()));
					imgsItem.set(i, "/product/" + itemNum + "/image/" + i);
		}
	}
